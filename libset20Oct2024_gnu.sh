...
#5. TIFF----------------------------------
#tiff-4.6.0t: https://gitlab.com/libtiff/libtiff/-/releases
echo "...compiling tiff..."
...
echo "...compiling cdo..."
tar -xzvf cdo-2.4.4.tar.gz; cd cdo-2.4.4;./configure --prefix=${INSTALL_DIR} --with-netcdf=${INSTALL_DIR} --with-hdf5=${INSTALL_DIR} --with-szlib=${INSTALL_DIR} --with-udunits2=${INSTALL_DIR} --with-eccodes=${INSTALL_DIR} --with-proj=${INSTALL_DIR} --with-libxml2=yes; make; make install; cd ..
...
#IMPOARTANT: Put the following lines in your ~/.bashrc (without #)
